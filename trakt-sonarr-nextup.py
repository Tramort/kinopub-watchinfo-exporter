...
DEFAULT_STATE_FILE = Path("data/trakt_sonarr_nextup_state.json")
        ...
        self.session.headers.update(
            {
                ...
                "User-Agent": "kinopub-watchinfo-exporter/trakt-sonarr-nextup",
            }
        )
...
def ensure_list(api: TraktApi, *, name: str, slug: str, create: bool) -> Optional[str]:
    ...
    created = create_list(
        ...
        description=(
            ...
            "Generated by trakt-sonarr-nextup.py because Sonarr In Progress "
